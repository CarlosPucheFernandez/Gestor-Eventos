...
public class RegistrarseController implements Initializable {
    ...
    private void Guardar(ActionEvent event) throws IOException {
        ...
        if (todoOk) {
            ...
            System.out.println(tfNombre.getText() + " , " + tfApe1.getText() + " , " + tfApe2.getText() + " , " + tfMail.getText() + " , " + taObservaciones.getText() + " , " + espinAcompanantes.getValue() + " , " + tfTelefono.getText() + " , " + comboEventos.getValue());
            ar.nuevoReserva(tfNombre.getText(), tfApe1.getText(), tfApe2.getText(), tfMail.getText(), taObservaciones.getText(), espinAcompanantes.getValue(), tfTelefono.getText(), comboEventos.getValue());
